    ...
    <footer className="bg-slate-900 text-slate-300 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>123 Đường Lê Lợi, Quận 1, TP. Hồ Chí Minh, Việt Nam</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>contact@vietstay.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 mt-10 pt-6 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} VietStay. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );
